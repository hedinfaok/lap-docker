...
RUN apt-get update
RUN apt-get install -y apache2 php-pear php5-curl php5-mysql php5-odbc php5-imagick php5-mcrypt mysql-client curl git libsasl2-modules rsyslog python-setuptools libapache2-mod-php5 php5-imap
